...
class BiS_v2(object):
    ...
    def biophys(self):
        ...
        for sec in self.all:
            sec.insert('ichan2bs')
            for seg in sec:
                seg.ichan2bs.gnatbar = gna
                seg.ichan2bs.gkfbar  = gk
                seg.ichan2bs.gl = gleak
                seg.ichan2bs.el = vrest
            ...
            sec.insert('borgka')
            for seg in sec:
                seg.borgka.gkabar = 0.00005

            sec.insert('nca')
            for seg in sec:
                seg.nca.gncabar = 0.0004

            sec.insert('lca')
            for seg in sec:
                seg.lca.glcabar = 0.004
