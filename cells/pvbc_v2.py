...
class PVBC_v2(object):
    ...
    def biophys(self):
        ...
        for sec in self.all:
            sec.insert('ichan2bc')
            for seg in sec:
                seg.ichan2bc.gnatbar = gna
                seg.ichan2bc.gkfbar  = gk #0.013
                seg.ichan2bc.gl = gleak #0.00018
                seg.ichan2bc.el = -61.4
            ...
            sec.insert('borgka')
            for seg in sec:
                seg.borgka.gkabar = 0.00015*4*0.5 #0.00015
            ...
            sec.insert('gskch')
            for seg in sec:
                seg.gskch.gskbar = 0.000002 * 2. #0.000002 

            sec.insert('mykca')
            for seg in sec:
                seg.mykca.gkbar = 0.0002*10. #0.0002
    ...
    def synapses(self):
        for sec in self.all:
            ...
            self.synGroups['STDPE2ASYM'][name] = {}
